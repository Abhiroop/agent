...
sysconfdir = "/Users/abhiroop/Haskell/agent/.stack-work/install/x86_64-osx/lts-8.24/8.0.2/etc"

getBinDir, getLibDir, getDynLibDir, getDataDir, getLibexecDir, getSysconfDir :: IO FilePath
getBinDir = catchIO (getEnv "agent_bindir") (\_ -> return bindir)
getLibDir = catchIO (getEnv "agent_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "agent_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "agent_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "agent_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "agent_sysconfdir") (\_ -> return sysconfdir)
